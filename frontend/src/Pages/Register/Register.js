                ...
                <div className='w-full p-4 bg-white  rounded-r-lg sm:p-6 md:p-8'>
                    <form onSubmit={submitHandler} className="space-y-6">
                        <div className='flex'>
                            ...
                            <h5 className="text-xl font-medium text-gray-900 dark:text-white ml-4">Sign up your account</h5>
                        </div>
                        <div>
                        ...
                        <button type="submit" className="w-full text-white bg-[#252121]     font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign Up your account</button>
                        <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                            Already registered? <Link to='/login' className="text-[#393f81] hover:underline">Sign In</Link>
                        </div>
                    </form>
                </div>
            </div>
